...
ifeq ($(TW_SHOW_LEGACY_ADVANCED),false)
    LOCAL_CFLAGS += -DTW_HIDE_LEGACY_ADVANCED
endif
...
ifeq ($(TW_DASH_RELEASE_CRYPTO_MOUNTS_AFTER_DECRYPT),true)
    LOCAL_CFLAGS += -DTW_DASH_RELEASE_CRYPTO_MOUNTS_AFTER_DECRYPT
endif
